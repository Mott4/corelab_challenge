...
class AppModule extends Module {
  ...
  void routes(RouteManager r) {
    r.module(AppRoutes.initial, module: DashboardModule(), transition: TransitionType.noTransition);
    r.module(AppRoutes.category, module: CategoriesModule(), transition: TransitionType.noTransition);
    r.module(AppRoutes.searchResult, module: SearchModule(), transition: TransitionType.noTransition);
